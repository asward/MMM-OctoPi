...
(function(global, factory) {
    ...
    OctoPrintClient.deprecated = function(deprecatedFct, newFct, fn) {
        return function() {
            console.warn(deprecatedFct + " is deprecated, please use the new " +
                newFct + " function instead");
...
(function(global, factory) {
    ...
    OctoPrintBrowserClient.prototype.passiveLogin = function(opts) {
        return this.base.postJson(loginUrl, {
            passive: true
        }, opts);
    };
...
(function(global, factory) {
    ...
    OctoPrintFilesClient.prototype.sanitize = function(location, path, filename, opts) {
        return this.base.issueCommand(testUrl, "sanitize", {
            storage: location,
            path: path,
            filename: filename
        }, opts);
    ...
    OctoPrintFilesClient.prototype.exists = function(location, path, filename, opts) {
        return this.base.issueCommand(testUrl, "exists", {
            storage: location,
            path: path,
            filename: filename
        }, opts);
...
(function(global, factory) {
    ...
    OctoPrintJobClient.prototype.pause = function(opts) {
        return this.issueCommand("pause", {
            action: "pause"
        }, opts);
    };
    ...
    OctoPrintSettingsClient.prototype.getPluginSettings = function(plugin, opts) {
        return this.get(opts).then(function(settings, statusText, request) {
            if (!settings.plugins || !settings.plugins[plugin]) {
                return $.Deferred().reject(request, "dataerror", "No settings for plugin " + plugin).promise();
            } else {
...
(function(global, factory) {
    ...
    OctoPrintTimelapseClient.prototype.list = function(opts) {
        var deferred = $.Deferred();
        this.get(true, opts).done(function(response, status, request) {
            deferred.resolve({
    ...
    OctoPrintTimelapseClient.prototype.listRendered = function(opts) {
        var deferred = $.Deferred();
        this.get(false, opts).done(function(response, status, request) {
...
(function(global, factory) {
    ...
    OctoPrintAppKeysClient.prototype.generateKey = function(app, opts) {
        return this.base.simpleApiCommand("appkeys", "generate", {
            app: app
        }, opts);
    };
    ...
    OctoPrintAppKeysClient.prototype.revokeKey = function(key, opts) {
        return this.base.simpleApiCommand("appkeys", "revoke", {
            key: key
        }, opts);
    };
    OctoPrintAppKeysClient.prototype.decide = function(token, decision, opts) {
        return this.base.postJson(this.base.getBlueprintUrl("appkeys") + "decision/" + token, {
            decision: !!decision
        }, opts);
    };
    ...
    OctoPrintAppKeysClient.prototype.requestForUser = function(app, user, opts) {
        return this.base.postJson(this.base.getBlueprintUrl("appkeys") + "request", {
            app: app,
            user: user
        }, opts);
    };
    ...
    OctoPrintAppKeysClient.prototype.authenticate = function(app, user) {
        var deferred = $.Deferred();
        var client = this;
        client.probe().done(function() {
            client.requestForUser(app, user).done(function(response) {
                ...
                var interval = 1000;
                var poll = function() {
                    client.checkDecision(token).done(function(response) {
                        if (response.api_key) {
...
(function(global, factory) {
    ...
    OctoPrintPluginManagerClient.prototype.get = function(refresh, opts) {
        console.log("Deprecated endpoint OctoPrint.plugin.pluginmanager.get, " + "please use OctoPrint.plugin.pluginmanager.get*");
        ...
        return this.base.get(this.base.getSimpleApiUrl("pluginmanager") +
            (query.length ? "?" + query.join("&") : ""), opts);
    };
    OctoPrintPluginManagerClient.prototype.getWithRefresh = function(opts) {
        console.log("Deprecated endpoint OctoPrint.plugin.pluginmanager.getWithRefresh, " + "please use OctoPrint.plugin.pluginmanager.get*");
        return this.get(true, opts);
    };
    OctoPrintPluginManagerClient.prototype.getWithoutRefresh = function(opts) {
        console.log("Deprecated endpoint OctoPrint.plugin.pluginmanager.getWithoutRefresh, " + "please use OctoPrint.plugin.pluginmanager.get*");
